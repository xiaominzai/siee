...
<!--main-->
    ...
    <img src="<?php echo IMG_PATH;?>01.jpg" alt="" width="1003px" height="225px" style="margin-top: 5px;">
        </div>
            <div id="content">
                ...
                <div class="list-dd" id="sc-dongtai">
                    ...
                    <ul class="listdd-down">
                        <?php $n=1;if(is_array($data)) foreach($data AS $v) { ?>
                        <li>
                            <img src="<?php echo IMG_PATH;?>dian.svg" class="dian"><a class="listdd-c" href="<?php echo $v['url'];?>" ><span><?php echo $v['title'];?></span></a>
                ...
                <div class="list-dd" id="baoming">
                    ...
                    <div class="listdd-down">
                        ...
                        <div id="baoming-right">
                            <div class="baoming-top"><img src="<?php echo IMG_PATH;?>BMtubiao3.jpg" width="38" /></div>
